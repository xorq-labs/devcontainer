...
def load_grouped_prefixes(prefixes_file=None):
    if prefixes_file:
        list_file = Path(prefixes_file)
    else:
...
def main():
    ...
    prefixes_file = sys.argv[3] if len(sys.argv) > 3 else None
    ...
    grouped_prefixes = load_grouped_prefixes(prefixes_file)
