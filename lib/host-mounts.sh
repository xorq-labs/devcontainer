...
#
# Sourcer must provide: DEV_PROJECT_DIR, DEV_CONTAINER_NAME, read_list()

generate_host_mounts_override() {
    local project_file="$DEV_PROJECT_DIR/host-mounts.txt"
    local local_file="$DEV_PROJECT_DIR/host-mounts.local.txt"
