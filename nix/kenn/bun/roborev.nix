# GENERATED by ./update.py --source --tool roborev --rev <ref>. Do not hand-edit.
#
# kenn-io/roborev ships no bun.nix of its own (unlike msgvault), so this is
# regenerated from its bun.lock on every rev bump and belongs to the
# source-builds.json entry for 'roborev'. See ADR-0007 and nix/kenn/README.md.
...
}:
{
  ...
  "@effect/platform-browser@4.0.0-beta.102" = fetchurl {
    url = "https://registry.npmjs.org/@effect/platform-browser/-/platform-browser-4.0.0-beta.102.tgz";
    hash = "sha512-DXXVt+oOpukqI3lEaGvvXQxSobzIy3lAsIQvlpVK+MuYBm1o4FHZrHKbrOFItDUvSR1t0kiTncFPRi01YaJUmA==";
  };
  ...
  "@kenn-io/roborev-ui" = copyPathToStore ./packages/roborev-ui;
  "@kenn-io/roborev-web" = copyPathToStore ./web;
  ...
  "@redocly/openapi-core@1.34.19" = fetchurl {
    url = "https://registry.npmjs.org/@redocly/openapi-core/-/openapi-core-1.34.19.tgz";
    hash = "sha512-o/0VgsBXgwcY1lyeqcVtSGdTQAPnVggo0fbFVPlxl5XVDKUcVH0OLRqt3CbkwByT5FU305E0iE0O7MzThjDblw==";
  };
  ...
  "esrap@2.3.2" = fetchurl {
    url = "https://registry.npmjs.org/esrap/-/esrap-2.3.2.tgz";
    hash = "sha512-40GyiEJevYKXzYTHtZkFqAgTjLOuFcaXMao8TPyOlnWTlkHDlvZ6mPMJaJyOqVwrVCgomEG1WhJd81w0X+IcCw==";
  };
